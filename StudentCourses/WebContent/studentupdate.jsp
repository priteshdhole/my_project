            ...
            <div class="row">
            	<div class="col-md-6">
            		<form action="./student" method="post">
            			<div class="container">
            				<div class="row">
	          					<div class="col-md-3"><input type="hidden" name="page" value="UpdateStudent" class="form-control form-control-sm"/></div>
	          					<div class="col-md-3"><input type="hidden" name="studentDetail" value="<%=student.getPhone() %>-<%=student.getCourse()%>" /></div>
	          				</div>
	          				<div class="row">
	          					...
	          					<div class="col-md-6">
	          						<select name="course" class="form-control form-control-sm">
	          							...
	          							<%
	          								...
	          								{
	          							%>
	          								<option <%=student.getCourse().equals(courseName)?"Selected":""%> value="<%=courseName %>"><%=courseName %></option>
	          							<%
	          								}
	          							%>
	          						</select>
